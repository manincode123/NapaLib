    ...
    $.fn.extend({
        jTLine: function (options) {
            ...
            var defaults = {
                ...
                formatPointContent: function (pointCnt,obj) { }
            ...
            var setTimelineWidth = function (timelineComponents, width) {
                ...
                if (totalWidth < 720) totalWidth= 720;
            ...
            var updateVisibleContent = function (event, eventsContent) {
                ...
                eventsContent.css('max-height', selectedContentHeight + 'px');
            }
            ...
            */
            ...
            var _constructDom = function (jsonData, mainObject) {
                ...
                for (var i = 0; i < dataCollection.length; i++) {
                    ...
                    point = {
                        ...
                        "pointCnt": formatPointContent(dataCollection[i][options.map.dateValue], dataCollection[i]),
            ...
            var formatPointContent = function (pointCnt, obj) {
                var formatPntCnt = options.formatPointContent(pointCnt, obj);
                if (formatPntCnt)
                    return options.formatPointContent(pointCnt, obj);
                else
                    return pointCnt;
            }
